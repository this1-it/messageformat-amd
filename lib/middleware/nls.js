 ...
 * @param {string} [userOptions.includeJs]
 * @return {object}
 */
function setUpOptions(userOptions)
{
  ...
  options.includeJs = typeof userOptions.includeJs === 'string'
    ? userOptions.includeJs
    : fs.readFileSync(require.resolve('messageformat/lib/messageformat.include.js'), 'utf8');
